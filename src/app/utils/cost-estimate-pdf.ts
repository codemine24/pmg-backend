...
export async function renderCostEstimatePDF(data: InvoicePayload & { estimate_number: string; estimate_date: Date }): Promise<Buffer> {
    ...
    return new Promise((resolve, reject) => {
        try {
            ...
            doc.rect(orderBoxX, detailsY, detailBoxWidth, 40)
                .lineWidth(1)
                .stroke('#ccc')
            ...
            doc.rect(margin, infoY + 12, contentWidth * 0.48, 1)
                .fill('#000')
            ...
            doc.rect(eventX, infoY + 12, contentWidth * 0.48, 1)
                .fill('#000')
            ...
            doc.fontSize(9)
                ...
                .text(`${data.venue_city}, ${data.venue_country}`, eventX, doc.y + 2, { width: contentWidth * 0.48 })
            ...
            // Background box
            doc.rect(summaryX, totalY, summaryWidth, totalHeight)
                .lineWidth(2)
                .stroke('#000')
