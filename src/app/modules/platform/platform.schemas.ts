...
const configSchema = z.object({
  ...
  primary_color: z
    .string()
    .regex(/^#([0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/, "Primary color must be a valid hex color code (e.g., #FFF or #FFFFFF)")
    .optional(),
  secondary_color: z
    .string()
    .regex(/^#([0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/, "Secondary color must be a valid hex color code (e.g., #FFF or #FFFFFF)")
    .optional(),
  logistics_partner_name: z.string().max(100, "Logistics partner name must be at most 100 characters").optional(),
